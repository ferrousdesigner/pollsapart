...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AddPoll')
              : AddPollWidget(),
        ),
        FFRoute(
          name: 'Signup',
        ...
        FFRoute(
          ...
          path: '/pollMetric',
          requireAuth: true,
          builder: (context, params) => PollMetricWidget(
            pollRef: params.getParam(
                'pollRef', ParamType.DocumentReference, false, ['polls']),
          ),
        ),
        FFRoute(
          name: 'UpdateProfile',
        ...
        FFRoute(
          ...
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: PublicProfileWidget(
              userRefParam: params.getParam('userRefParam',
        ...
        FFRoute(
          ...
          requireAuth: true,
          asyncParams: {
            'poll': getDoc(['polls'], PollsRecord.fromSnapshot),
          },
          builder: (context, params) => ReportAbuseWidget(
            poll: params.getParam('poll', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'Menu',
